...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery");+function (t) {
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        var n = window.SVGElement && i instanceof window.SVGElement, a = o ? {top: 0, left: 0} : n ? null : e.offset(),
...
}if ("undefined" == typeof Haravan) var Haravan = {};Haravan.cultures = [{
    code: "vi-VN",
    thousands: ",",
    decimal: ".",
    numberdecimal: 0,
...
/*
var SmoothScroll=function(){function e(e){var t=this;this.endThreshold=.05,this.requestId=null,this.maxDepth=10,this.viewHeight=0,this.halfViewHeight=0,this.maxDistance=0,this.scrollHeight=0,this.endScroll=0,this.currentScroll=0,this.resizeRequest=1,this.scrollRequest=0,this.scrollItems=[],this.lastTime=-1,this.maxElapsedMS=100,this.targetFPMS=.06,this._onResize=function(e){t.resizeRequest++,t.requestId||(t.lastTime=performance.now(),t.requestId=requestAnimationFrame(t._update))},this._onScroll=function(e){t.scrollRequest++,t.requestId||(t.lastTime=performance.now(),t.requestId=requestAnimationFrame(t._update))},this._update=function(e){void 0===e&&(e=performance.now());var s=e-t.lastTime;s>t.maxElapsedMS&&(s=t.maxElapsedMS);var r=s*t.targetFPMS,l=1-Math.pow(1-t.scrollEase,r),i=t.resizeRequest>0,o=t.scrollBody.scrollTop;if(i){var a=t.target.clientHeight;t.scrollSpacer.style.height=a+"px",t.scrollHeight=a,t.viewHeight=window.innerHeight,t.halfViewHeight=t.viewHeight/2,t.maxDistance=2*t.viewHeight,t.resizeRequest=0}t.endScroll=o,t.currentScroll+=(o-t.currentScroll)*l,(Math.abs(o-t.currentScroll)<t.endThreshold||i)&&(t.currentScroll=o,t.scrollRequest=0);var n=t.currentScroll+t.halfViewHeight;t.target.style.transform="translate3d(0px,-"+t.currentScroll+"px,0px)";for(var h=0;h<t.scrollItems.length;h++){var c=t.scrollItems[h],d=(n-c.top)/t.maxDistance;c.endOffset=Math.round(t.maxOffset*c.depthRatio*d),Math.abs(c.endOffset-c.currentOffset<t.endThreshold)?c.currentOffset=c.endOffset:c.currentOffset+=(c.endOffset-c.currentOffset)*l,c.target.style.transform="translate3d(0px,-"+c.currentOffset+"px,0px)"}t.lastTime=e,t.requestId=t.scrollRequest>0?requestAnimationFrame(t._update):null},this.scrollBody=e.scrollBody,this.scrollSpacer=e.scrollSpacer,this.target=e.target,this.scrollEase=null!=e.scrollEase?e.scrollEase:.1,this.maxOffset=null!=e.maxOffset?e.maxOffset:500,this.addItems(),window.addEventListener("resize",this._onResize),this.scrollBody.addEventListener("scroll",this._onScroll),this._update()}return e.prototype.addItems=function(){this.scrollItems=[];for(var e=document.querySelectorAll("*[data-depth]"),t=0;t<e.length;t++){var s=e[t],r=+s.getAttribute("data-depth"),l={target:s,depth:r,top:s.getBoundingClientRect().top+this.scrollBody.scrollTop,depthRatio:r/this.maxDepth,currentOffset:0,endOffset:0};this.scrollItems.push(l)}return this},e}();
*/
